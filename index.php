<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            <form class="form-horizontal" action="" id="contactForm" method="post">
                <div class="row para">
                    <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                        |, <u>'.$name1.'</u> &nbsp;(print name) have read the above paragraph and accept the conditions listed.
                    </p>
                </div>

                 <div class="row para">
                     <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                         Signature:<u> '.$signature1.'</u>&nbsp;&nbsp;&nbsp; Date:<u>'.$date1.'</u>
                     </p>
                 </div>
                ...
                <div class="container">
                    ...
                    <div class="row para">
                    <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                        |, <u>'.$name2.'</u> &nbsp;(print name) have read the above paragraph and accept the conditions listed.
                    </p>
                </div>

                 <div class="row para">
                     <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                         Signature:<u> '.$signature2.'</u>&nbsp;&nbsp;&nbsp; Date:<u>'.$date2.'</u>
                     </p>
                 </div>
                ...
                <div class="container">
                    ...
                    <div class="row para">
                    <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                        |, <u>'.$name3.'</u> &nbsp;(print name) have read the above paragraph and accept the conditions listed.
                    </p>
                </div>

                 <div class="row para">
                     <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                         Signature:<u> '.$signature3.'</u>&nbsp;&nbsp;&nbsp; Date:<u>'.$date3.'</u>
                     </p>
                 </div>
                ...
                <div class="container">
                    ...
                    <div class="row para">
                    <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                        |, <u>'.$name4.'</u> &nbsp;(print name) have read the above paragraph and accept the conditions listed.
                    </p>
                </div>

                 <div class="row para">
                     <p style="font-size: 22px; font-weight: 900px; padding-top: 10px;">
                         Signature:<u> '.$signature4.'</u>&nbsp;&nbsp;&nbsp; Date:<u>'.$date4.'</u>
                     </p>
                 </div>
        ...
        $mail->addAddress('info@cleanmyteeth.ca'); 
        //Send HTML or Plain Text email
        $mail->isHTML(true);
        $mail->addAttachment($file_name);
        $mail->Subject = "New Consent Form Submission"; 
        $mail->Body = 'Please Find Customer Consent in attach PDF File.';
